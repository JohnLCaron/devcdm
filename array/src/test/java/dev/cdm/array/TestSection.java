...
public class TestSection {
  ...
  @Test
  public void testSectionAgainstOriginal() throws InvalidRangeException {
  ...
  @Test
  public void testComposeSliceWithSection() throws InvalidRangeException {
    // 1:1,0:3,1:5
    ...
    System.out.printf("array((i * 100 + j * 10 + k))%s%n", PrintArray.printArray(A));
    System.out.printf("section(%s) %s%n", sec1, PrintArray.printArray(secA1));
    System.out.printf("slice(1,2) %s%n", PrintArray.printArray(secA2));
