...
public class TestGridSubset {
  ...
  public void testLatLonPoint() {
    ...
    LatLonPoint llpt = new LatLonPoint(99.0, .5);
    subset.setLatLonPoint(llpt);
    assertThat(subset.getLatLonPoint()).isEqualTo(llpt);
    assertThat(subset.getLatLonPoint()).isEqualTo(new LatLonPoint(99.0, .5));
  ...
  public void testTimeOffsetCoord() {
    GridSubset subset = GridSubset.create();
    CoordInterval offsetv = new CoordInterval(34.56, 78.9);
  ...
  public void testStringConstructor() {
    GridSubset subset = GridSubset.create();
    CoordInterval offsetv = new CoordInterval(34.5, 78.9);
    ...
    subset.setLatLonPoint(new LatLonPoint(99.0, .5)); // LatLonPoint
