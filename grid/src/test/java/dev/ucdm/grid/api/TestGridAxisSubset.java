...
public class TestGridAxisSubset {
  ...
  public void testTimeOffsetIrregular() {
    ...
    subset =
        axis1D.subset(GridSubset.create().setTimeOffsetCoord(new CoordInterval(40.0, 41.0)), errlog).orElseThrow();
    assertThat(subset.getNominalSize()).isEqualTo(1);
    assertThat(subset.getSubsetRange()).isEqualTo(Range.make(4, 4));
    assertThat(subset.getSpacing()).isEqualTo(GridAxisSpacing.regularPoint);
  ...
  public void testVertPointIrregular() {
    ...
    subset = axis1D.subset(GridSubset.create().setVertCoord(new CoordInterval(40.0, 41.0)), errlog).orElseThrow();
    assertThat(subset.getNominalSize()).isEqualTo(1);
    assertThat(subset.getSubsetRange()).isEqualTo(Range.make(4, 4));
    assertThat(subset.getSpacing()).isEqualTo(GridAxisSpacing.regularPoint);
  }
  ...
  public void testTimeNominalPoint() {
    ...
    GridSubset params = GridSubset.create().setTimeOffsetCoord(new CoordInterval(21.0, 22.0));
  ...
  public void testDescendingVertInterval() {
    ...
    assertThat(subset.getCoordinate(0)).isEqualTo(new CoordInterval(90.0, 80.0));

    subset = axis1D.subset(GridSubset.create().setVertCoord(new CoordInterval(40.0, 41.0)), errlog).orElseThrow();
    assertThat(subset.getNominalSize()).isEqualTo(1);
    assertThat(subset.getSubsetRange()).isEqualTo(Range.make(5, 5));
    assertThat(subset.getCoordinate(0)).isEqualTo(new CoordInterval(50.0, 40.0));
  }
  ...
  public void testTimeInterval() {
    ...
    assertThat(subset.getNominalSize()).isEqualTo(1);
    assertThat(subset.getSubsetRange()).isEqualTo(Range.make(3, 3));
    assertThat(subset.getCoordinate(0)).isEqualTo(new CoordInterval(20.0, 40.0));

    subset = axis1D.subset(GridSubset.create().setTimeOffsetCoord(41.0), errlog).orElseThrow();
    assertThat(subset.getNominalSize()).isEqualTo(1);
    assertThat(subset.getSubsetRange()).isEqualTo(Range.make(4, 4));
    assertThat(subset.getCoordinate(0)).isEqualTo(new CoordInterval(40.0, 80.0));
    ...
    assertThat(subset.getCoordinate(0)).isEqualTo(new CoordInterval(80.0, 100.0));
  ...
  public void testTimeDiscontiguousInterval() {
    ...
    assertThat(axis1D.subset(GridSubset.create().setTimeOffsetCoord(new CoordInterval(18.0, 42.0)), errlog))
        .isEmpty();

    // 2 intervals overlap
    subset =
        axis1D.subset(GridSubset.create().setTimeOffsetCoord(new CoordInterval(2.0, 2.2)), errlog).orElseThrow();
    assertThat(subset.getNominalSize()).isEqualTo(1);
    assertThat(subset.getSubsetRange()).isEqualTo(Range.make(0, 0));
    assertThat(subset.getCoordinate(0)).isEqualTo(new CoordInterval(0, 3));
  }
