...
public class TestGridAxis {
  ...
  public void testRegularPoint() {
    ...
    assertThat(Grids.getCoordEdgeMinMax(axis1D)).isEqualTo(new MinMax(-5.0, 65.0));
    ...
    for (int i = 0; i < axis1D.getNominalSize(); i++) {
      ...
      assertThat(axis1D.getCoordInterval(i)).isEqualTo(new CoordInterval(10.0 * i - 5.0, 10.0 * i + 5.0));
    }
  ...
  public void testIrregularPoint() {
    ...
    assertThat(axis1D.isInterval()).isFalse();
    assertThat(Grids.getCoordEdgeMinMax(axis1D)).isEqualTo(new MinMax(-2.5, 110.0));
  ...
  public void testNominalPoint() {
    ...
    assertThat(axis1D.isRegular()).isFalse();
    assertThat(axis1D.isInterval()).isFalse();
    assertThat(Grids.getCoordEdgeMinMax(axis1D)).isEqualTo(new MinMax(0, 100.0));
  ...
  public void testRegularInterval() {
    ...
    for (CoordInterval coord : axis1D) {
      assertThat(coord).isEqualTo(new CoordInterval(10.0 * count - 5.0, 10.0 * count + 5.0));
      count++;
    }
  ...
  public void testContiguousInterval() {
    ...
    for (int i = 0; i < axis1D.getNominalSize(); i++) {
      ...
      assertThat(axis1D.getCoordInterval(i)).isEqualTo(new CoordInterval(values[i], values[i + 1]));
    }
  ...
  public void testDiscontiguousInterval() {
    ...
    assertThat(axis1D.isRegular()).isFalse();
    assertThat(axis1D.isInterval()).isTrue();
    assertThat(Grids.getCoordEdgeMinMax(axis1D)).isEqualTo(new MinMax(0, 100));
    ...
    for (int i = 0; i < axis1D.getNominalSize(); i++) {
      ...
      assertThat(axis1D.getCoordInterval(i)).isEqualTo(new CoordInterval(values[2 * i], values[2 * i + 1]));
    }
    ...
    for (Object coord : axis1D) {
      ...
      assertThat(val).isEqualTo(new CoordInterval(values[count], values[count + 1]));
      count += 2;
    }
