...
import dev.cdm.array.RangeComposite;
...
public class CylindricalCoord {
  ...
  public Array<Number> readSpecial(MaterializedCoordinateSystem subsetCoordSys, Grid grid)
    ...
    Array<Number> data0 = grid.readDataSection(new dev.cdm.array.Section(ranges));
    ranges.set(last, this.saveIntvs.get(1));
    Array<Number> data1 = grid.readDataSection(new dev.cdm.array.Section(ranges));
