...
public interface Grid extends IsMissingEvaluator {
   ...
   */
  GridReferencedArray readData(GridSubset subset) throws IOException, dev.cdm.array.InvalidRangeException;
  ...
  // experimental
  Array<Number> readDataSection(dev.cdm.array.Section subset) throws InvalidRangeException, IOException;
