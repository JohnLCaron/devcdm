...
public class GridDatasetFactory {
  ...
  public static GridDataset openGridDataset(String endpoint, Formatter errLog) throws IOException {
    ...
    // this will still open a GRIB Collection, but it will be built on top of CdmDataset.
  ...
  public static GridDataset openNetcdfAsGrid(String endpoint, Formatter errLog) throws IOException {
    ...
    CdmDatasetCS ds = CdmDatasets.openDatasetCS(endpoint);
  ...
  public static Optional<GridDataset> wrapGridDataset(CdmDatasetCS ds, Formatter errLog) throws IOException {
    ...
    return Optional.of((GridDataset) result.get());
  }
