...
public class GcdmServer {
  ...
  static class GcdmImpl extends GcdmImplBase {
    ...
    public void getCdmData(DataRequest req, StreamObserver<DataResponse> responseObserver) {
      ...
      try (CdmFile ncfile = CdmDatasets.openFile(req.getLocation(), null)) { // TODO cache ncfile?
    ...
    public void getGridData(GcdmGridProto.GridDataRequest request,
        io.grpc.stub.StreamObserver<dev.ucdm.gcdm.protogen.GcdmGridProto.GridDataResponse> responseObserver) {
