...
package dev.cdm.grib.grib1;

import dev.cdm.grib.util.GdsHorizCoordSys;
import dev.cdm.grib.util.GribNumbers;
import dev.cdm.grib.util.QuasiRegular;
...
public abstract class Grib1Gds {
  ...
  public static Grib1Gds factory(int template, byte[] data) {
    return switch (template) {
      case 0 -> new LatLon(data, 0);
      case 1 -> new Mercator(data, 1);
      case 3 -> new LambertConformal(data, 3);
      case 4 -> new GaussianLatLon(data, 4);
      case 5 -> new PolarStereographic(data, 5);
      case 10 -> new RotatedLatLon(data, 10);
      case 50 -> new SphericalHarmonicCoefficients(data, 50);
      default -> new UnknownGds(data, template);
    };
  }
  ...
  public static class LatLon extends Grib1Gds {
    ...
    LatLon(byte[] data, int template) {
      ...
      if (Float.isFinite(calcDelta) && !NumericCompare.nearlyEquals(deltaLon, calcDelta)) {
      ...
      // point in the GDS, which can lead to NaN or +/-Inf), can compare deltaLon
      // against a calculated delta, which appears to be more accurate in some cases.
      if (Float.isFinite(calcDelta) && !NumericCompare.nearlyEquals(deltaLat, calcDelta)) {
    ...
    public boolean equals(Object o) {
      ...
      if (!NumericCompare.nearlyEquals(deltaLat, other.deltaLat)) {
        return false;
      }
      return NumericCompare.nearlyEquals(deltaLon, other.deltaLon);
    }
    ...
    public int hashCode() {
      if (hashCode == 0) {
        ...
        int useDeltaLon = (int) (deltaLon / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLat = (int) (deltaLat / NumericCompare.defaultMaxRelativeDiffFloat);
  ...
  public static class PolarStereographic extends Grib1Gds {
    ...
    public int hashCode() {
      if (hashCode == 0) {
        ...
        int useLov = (int) (lov / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLon = (int) (dX / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLat = (int) (dY / NumericCompare.defaultMaxRelativeDiffFloat);
  ...
  public static class LambertConformal extends Grib1Gds {
    ...
    public int hashCode() {
      if (hashCode == 0) {
        int useLat = (int) (la1 / (maxReletiveErrorPos * dY)); // Two equal objects must have the same hashCode() value
        int useLon = (int) (lo1 / (maxReletiveErrorPos * dX));
        int useLad = (int) (lad / NumericCompare.defaultMaxRelativeDiffFloat);
        int useLov = (int) (lov / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLon = (int) (dX / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLat = (int) (dY / NumericCompare.defaultMaxRelativeDiffFloat);
        int useLatin1 = (int) (latin1 / NumericCompare.defaultMaxRelativeDiffFloat);
        int useLatin2 = (int) (latin2 / NumericCompare.defaultMaxRelativeDiffFloat);
  ...
  public static class Mercator extends Grib1Gds {
    ...
    public boolean equals(Object o) {
      ...
      if (!NumericCompare.nearlyEquals(latin, that.latin)) {
        return false;
      }
      if (!NumericCompare.nearlyEquals(dY, that.dY)) {
        return false;
    ...
    public int hashCode() {
      if (hashCode == 0) {
        int useLat = (int) (la1 / (maxReletiveErrorPos * dY)); // Two equal objects must have the same hashCode() value
        int useLon = (int) (lo1 / (maxReletiveErrorPos * dX));
        int useLad = (int) (latin / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLon = (int) (dX / NumericCompare.defaultMaxRelativeDiffFloat);
        int useDeltaLat = (int) (dY / NumericCompare.defaultMaxRelativeDiffFloat);
  ...
  public static class RotatedLatLon extends LatLon {
    ...
    public boolean equals(Object o) {
      ...
      return NumericCompare.nearlyEquals(angleRotation, other.angleRotation);
    }
    ...
    public GdsHorizCoordSys makeHorizCoordSys() {
      dev.cdm.dataset.geoloc.projection.RotatedLatLon proj =
          new dev.cdm.dataset.geoloc.projection.RotatedLatLon(latSouthPole, lonSouthPole, angleRotation);
