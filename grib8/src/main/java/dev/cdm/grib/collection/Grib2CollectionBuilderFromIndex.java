...
class Grib2CollectionBuilderFromIndex extends GribCollectionBuilderFromIndex {
  ...
  @Nullable
  static Grib2Collection readFromIndex(String name, RandomAccessFile raf, GribConfig config,
  ...
  Grib2CollectionBuilderFromIndex(String name, GribConfig config, org.slf4j.Logger logger) {
