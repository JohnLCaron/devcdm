...
public class Grib2PartitionBuilderFromIndex extends Grib2CollectionBuilderFromIndex {
  ...
  @Nullable
  static Grib2Partition createTimePartitionFromIndex(String name, RandomAccessFile raf, GribConfig config,
  ...
  private Grib2PartitionBuilderFromIndex(String name, GribConfig config, org.slf4j.Logger logger) {
  ...
  protected boolean readExtensions(GribCollectionProto.GribCollection proto) {
    ...
    for (dev.cdm.grib.collection.GribCollectionProto.Partition partProto : partList)
