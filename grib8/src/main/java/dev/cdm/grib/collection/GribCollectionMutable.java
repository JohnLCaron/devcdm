...
import dev.cdm.grib.grib2.Grib2SectionProductDefinition;
...
public class GribCollectionMutable implements Closeable {
  ...
  protected final GribConfig config;
  ...
  protected GribCollectionMutable(String name, File directory, GribConfig config, boolean isGrib1) {
    countGC++;
    this.name = name;
