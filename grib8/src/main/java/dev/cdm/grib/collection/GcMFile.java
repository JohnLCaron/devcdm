...
import dev.cdm.core.inventory.MFileNio;
 ...
 * @since 2/19/14
 */
public class GcMFile implements dev.cdm.core.inventory.MFile {
  ...
  public MFile getParent() {
    try {
      return new MFileNio(directory.toPath()); // wtf?
    } catch (IOException e) {
  ...
  @Override
  public int compareTo(dev.cdm.core.inventory.MFile o) {
