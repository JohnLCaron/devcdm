...
class Grib1PartitionBuilderFromIndex extends Grib1CollectionBuilderFromIndex {
  ...
  @Nullable
  static Grib1Partition createTimePartitionFromIndex(String name, RandomAccessFile raf, GribConfig config,
  ...
  static PartitionCollectionMutable openMutablePCFromIndex(String name, RandomAccessFile raf,
      GribConfig config, org.slf4j.Logger logger) {
  ...
  private Grib1PartitionBuilderFromIndex(String name, GribConfig config, org.slf4j.Logger logger) {
  ...
  protected boolean readExtensions(GribCollectionProto.GribCollection proto) {
    ...
    List<dev.cdm.grib.collection.GribCollectionProto.Partition> partList = proto.getPartitionsList();
    for (dev.cdm.grib.collection.GribCollectionProto.Partition partProto : proto.getPartitionsList())
