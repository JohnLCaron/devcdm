...
public abstract class GribIosp extends AbstractIOServiceProvider {
  ...
  public void build(RandomAccessFile raf, Group.Builder rootGroup, CancelTask cancelTask) throws IOException {
    ...
    if (gHcs != null) { // just use the one group that was set in the constructor
      ...
      this.gribCollection =
          GribCdmIndex.openGribCollectionFromRaf(raf, gribConfig, CollectionUpdateType.testIndexOnly, logger);
  ...
  @Override
  public Array<?> readArrayData(Variable v2, dev.cdm.array.Section section)
      throws java.io.IOException, dev.cdm.array.InvalidRangeException {
