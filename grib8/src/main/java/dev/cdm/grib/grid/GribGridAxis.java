...
import dev.cdm.grib.collection.Grib;
...
public class GribGridAxis {
  ...
  public static GribGridDataset.CoordAndAxis create(GribCollectionImmutable.Type type, Coordinate gribCoord, @Nullable GribIosp iosp) {
    switch (gribCoord.getType()) {
      ...
      case vert:
        ...
        if (vertCoord.isLayer()) {
          ...
          return new GribGridDataset.CoordAndAxis(gribCoord, axis.build());
        } else {
  ...
  ///////////////////////////////////////////////////////////////
  // re: CoordToGridAxis1D does this for CdmDataset
