package dev.cdm.grib.grib2.tools;

import com.google.common.collect.ImmutableList;
import java.io.File;
import java.util.Formatter;
import dev.cdm.grib.util.GribTables;
import dev.cdm.grib.grib2.table.EccodesParamTable;
import dev.cdm.grib.grib2.table.Grib2ParamTableInterface;
  ...
  public static void compareTables(Grib2ParamTableInterface t1, Grib2ParamTableInterface t2, Formatter f) {
    ...
    for (GribTables.Parameter p1 : t1.getParameters()) {
      ...
      if (p2 == null) {
        ...
        if (!WmoUtils.equivilantName(p1.getName(), p2.getName())) {
        ...
        if (!p1.getUnit().equalsIgnoreCase(p2.getUnit())) {
          String cu1 = WmoUtils.cleanUnit(p1.getUnit());
          String cu2 = WmoUtils.cleanUnit(p2.getUnit());

          // eliminate common non-udunits
          boolean isUnitless1 = WmoUtils.isUnitless(cu1);
          boolean isUnitless2 = WmoUtils.isUnitless(cu2);
