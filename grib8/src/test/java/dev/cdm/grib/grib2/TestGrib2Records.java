...
public class TestGrib2Records {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result.add(new Object[] {"MRMS_LowLevelCompositeReflectivity_00.50_20141207-072038.grib2", 0, 0, 24500000,
  ...
  public TestGrib2Records(String ds, int gdsTemplate, int param, long datalen, String refdateIso) {
    ...
    this.refdate = CalendarDate.fromUdunitIsoDate("ISO8601", refdateIso).orElseThrow();
