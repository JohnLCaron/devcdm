...
import dev.cdm.grib.grib1.Grib1Record;
import dev.cdm.grib.grib1.Grib1RecordScanner;
import dev.cdm.grib.grib1.Grib1SectionProductDefinition;
...
public class TestGrib1Records {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result.add(new Object[] {"complex_packing2.grib1", 4, 144, 131072,
        CalendarDate.fromUdunitIsoDate("ISO8601", "2015-11-09T00:00:00Z").orElseThrow()});
    result.add(new Object[] {"D2.2006091400.F012.002M.CLWMR.grib1", 5, 153, 102960,
        CalendarDate.fromUdunitIsoDate("ISO8601", "2006-09-14T00:00:00Z").orElseThrow()});
    result.add(new Object[] {"noaaRFC-QPE.grib1", 5, 237, 157500,
        CalendarDate.fromUdunitIsoDate("ISO8601", "2010-10-05T00:00:00Z").orElseThrow()});
    result.add(new Object[] {"rotatedlatlon.grib1", 10, 7, 176904,
        CalendarDate.fromUdunitIsoDate("ISO8601", "2003-12-15T18:00:00Z").orElseThrow()});
    result.add(new Object[] {"ncepPredefinedGds.grib1", 21000, 100, 37 * 36,
  ...
  private void readFile(String path, Callback callback) throws IOException {
    try (RandomAccessFile raf = new dev.cdm.core.io.RandomAccessFile(path, "r")) {
      raf.order(dev.cdm.core.io.RandomAccessFile.BIG_ENDIAN);
      raf.seek(0);
