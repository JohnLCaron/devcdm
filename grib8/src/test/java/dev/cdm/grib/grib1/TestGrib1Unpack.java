...
public class TestGrib1Unpack {
  ...
  public void testThisGridInterpolation() throws IOException, InvalidRangeException {
    ...
    int lineno = 0;
    try (dev.cdm.core.io.RandomAccessFile raf = new dev.cdm.core.io.RandomAccessFile(testfile, "r")) {
  ...
  private float[] getData(dev.cdm.core.io.RandomAccessFile raf, Grib1Record gr, GribData.InterpolationMethod method,
