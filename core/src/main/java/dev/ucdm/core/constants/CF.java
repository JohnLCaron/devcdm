...
public class CF {
  ...
  public enum FeatureType {
    ...
    @Nullable
    public static FeatureType convert(dev.ucdm.core.constants.FeatureType ft) {
      switch (ft) {
        case POINT:
    ...
    @Nullable
    public static dev.ucdm.core.constants.FeatureType convert(FeatureType cff) {
      switch (cff) {
        case point:
          return dev.ucdm.core.constants.FeatureType.POINT;
        case timeSeries:
          return dev.ucdm.core.constants.FeatureType.STATION;
        case profile:
          return dev.ucdm.core.constants.FeatureType.PROFILE;
        case trajectory:
          return dev.ucdm.core.constants.FeatureType.TRAJECTORY;
        case timeSeriesProfile:
          return dev.ucdm.core.constants.FeatureType.STATION_PROFILE;
        case trajectoryProfile:
          return dev.ucdm.core.constants.FeatureType.TRAJECTORY_PROFILE;
      }
      return null;
    }
