...
public class Dimension implements Comparable<Dimension> {
   ...
   * but it remains fixed for the lifetime of the CdmFile.
   ...
   * All Dimensions in CdmFile.getDimensions() or Group.getDimensions() are shared.
  ...
  public String makeFullName(Group containingGroup) {
    ...
    while (group != null) {
      if (group.findDimensionLocal(this.shortName) != null) {
        return CdmFiles.makeFullNameWithString(group, this.shortName);
      }
  ...
  void writeCDL(Formatter out, Indent indent, boolean strict) {
    String name = strict ? CdmFiles.makeValidCDLName(getShortName()) : getShortName();
    if (isVariableLength()) {
