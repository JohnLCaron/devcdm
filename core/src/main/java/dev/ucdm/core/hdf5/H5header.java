...
import dev.ucdm.core.hdf4.HdfEos;
import dev.ucdm.core.hdf4.HdfHeaderIF;
import dev.ucdm.core.io.RandomAccessFile;

import dev.ucdm.core.hdf5.H5objects.DataObject;
import dev.ucdm.core.hdf5.H5objects.DataObjectFacade;
import dev.ucdm.core.hdf5.H5objects.Filter;
import dev.ucdm.core.hdf5.H5objects.GlobalHeap;
import dev.ucdm.core.hdf5.H5objects.H5Group;
import dev.ucdm.core.hdf5.H5objects.HeaderMessage;
import dev.ucdm.core.hdf5.H5objects.HeapIdentifier;
import dev.ucdm.core.hdf5.H5objects.MessageAttribute;
import dev.ucdm.core.hdf5.H5objects.MessageComment;
import dev.ucdm.core.hdf5.H5objects.MessageDataspace;
import dev.ucdm.core.hdf5.H5objects.MessageDatatype;
import dev.ucdm.core.hdf5.H5objects.MessageFillValue;
import dev.ucdm.core.hdf5.H5objects.MessageFillValueOld;
import dev.ucdm.core.hdf5.H5objects.MessageFilter;
import dev.ucdm.core.hdf5.H5objects.MessageType;
import dev.ucdm.core.hdf5.H5objects.StructureMember;
...
public class H5header implements HdfHeaderIF {
  ...
  private Array<?> readAttributeData(MessageAttribute matt, Vinfo vinfo, ArrayType dataType)
      throws IOException, InvalidRangeException {
      ...
      if (vinfo.typeInfo.base.hdfType == 7) {
        ...
        while (layout2.hasNext()) {
          ...
          for (int i = 0; i < chunk.getNelems(); i++) {
            ...
            Array<String> refsArray = h5iosp.convertReferenceArray((Array<Long>) vlenArray);
  ...
  private StructureDataArray readAttributeStructureData(MessageAttribute matt, Vinfo vinfo)
      throws IOException, InvalidRangeException {
    ...
    StructureDataStorageBB storage = new StructureDataStorageBB(members, bb, nrows);
