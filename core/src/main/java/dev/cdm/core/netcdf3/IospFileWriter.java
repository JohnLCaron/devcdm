...
public interface IospFileWriter extends Closeable {
   ...
   * @return the CdmFile being written to
   */
  CdmFile create(String filename, Group.Builder rootGroup, int extra, long preallocateSize, boolean largeFile)
      throws IOException;
