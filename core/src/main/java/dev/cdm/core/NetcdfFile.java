 ...
 */
@Immutable
public class NetcdfFile implements Closeable {
   ...
   */
  @Nullable
  protected dev.cdm.array.Array<?> readArrayData(Variable v, dev.cdm.array.Section ranges)
   ...
   */
  public dev.cdm.array.Array<?> readSectionArray(String variableSection)
      throws IOException, dev.cdm.array.InvalidRangeException {
