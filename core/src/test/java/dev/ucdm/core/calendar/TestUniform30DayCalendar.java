...
import dev.ucdm.core.calendar.chrono.Uniform30DayDate;
...
/** Test {@link dev.ucdm.core.calendar.chrono.Uniform30DayChronology} */
public class TestUniform30DayCalendar {
  ...
  public void testInstant() {
    ...
    CalendarDate cdate30day = CalendarDate.ofInstant(Calendar.uniform30day, instant);

    assertThat(cdate.toString()).isNotEqualTo(cdate30day.toString());
    assertThat(cdate.hashCode()).isNotEqualTo(cdate30day.hashCode());
    assertThat(cdate).isNotEqualTo(cdate30day);
  }
