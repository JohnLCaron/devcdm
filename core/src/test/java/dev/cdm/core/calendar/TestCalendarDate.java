...
public class TestCalendarDate {
  ...
  public void testFloatLimits() {
    ...
    assertThat(OffsetDateTime.ofInstant(maxSecs, ZoneOffset.UTC).toString()).isEqualTo("1973-03-03T09:46:40Z");
    ...
    assertThat(OffsetDateTime.ofInstant(maxMins, ZoneOffset.UTC).toString()).isEqualTo("2160-02-18T10:40Z");
    ...
    assertThat(OffsetDateTime.ofInstant(maxHours, ZoneOffset.UTC).toString()).isEqualTo("+13377-12-11T16:00Z");
  }

  @Test
  public void testFromDate() {
    Date d = new Date(2020, 7, 17, 11, 11, 11);
    CalendarDate cd = CalendarDate.of(d);
    assertThat(cd.toInstant()).isEqualTo(d.toInstant());
  }
