...
public class TestReadVariableData extends TestCase {
  ...
  public void testNC3Read() throws Exception {
    try (CdmFile cdmfile = CdmFiles.open(TestCdmFiles.cdmLocalNetcdf3Dir + "testWrite.nc")) {
      ...
      Variable temp = null;
      assertThat(null != (temp = cdmfile.findVariable("temperature")));
      ...
      // read char variable
      Variable c = cdmfile.findVariable("svar");
      ...
      Variable c2 = cdmfile.findVariable("svar2");
      ...
      // read String Array
      Variable c3 = cdmfile.findVariable("names");
      ...
      // read String Array - 2
      Variable c4 = cdmfile.findVariable("names2");
