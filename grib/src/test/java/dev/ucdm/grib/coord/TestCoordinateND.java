...
public class TestCoordinateND {
  ...
  public void testCoordinateND() {
    ...
    assertThat(NumericCompare.nearlyEquals(curr.getSparseArray().getDensity(), 1.0f)).isTrue();
    assertThat(NumericCompare.nearlyEquals(reindexed.getSparseArray().getDensity(), .826446f)).isTrue();
  }
