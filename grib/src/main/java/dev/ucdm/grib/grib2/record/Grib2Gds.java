...
public abstract class Grib2Gds {
  ...
  public static Grib2Gds factory(int template, byte[] data) {
    Grib2Gds result = switch (template) {
      case 0 -> new LatLon(data);
      case 1 -> new RotatedLatLon(data);
      case 10 -> new Mercator(data);
      case 20 -> new PolarStereographic(data);
      case 30 -> new LambertConformal(data, 30);
      case 31 -> new AlbersEqualArea(data);
      case 40 -> new GaussLatLon(data);
      case 50 -> // Spherical Harmonic Coefficients BOGUS
              new GdsSpherical(data, template);
      case 90 -> new SpaceViewPerspective(data);

      // NCEP specific
      case 204 -> new CurvilinearOrthogonal(data);
      case 32769 -> new RotatedLatLon32769(data);
      default -> throw new UnsupportedOperationException("Unsupported GDS type = " + template);
    };
  ...
  public boolean equals(Object o) {
    ...
    if (template != grib2Gds.template)
      return false;
    return java.util.Arrays.equals(nptsInLine, grib2Gds.nptsInLine);
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + ny;
    if (nptsInLine != null)
      result = 31 * result + java.util.Arrays.hashCode(nptsInLine);
    return result;
  }
  ...
  public static class LatLon extends Grib2Gds {
    ...
    protected void finish() {
      ...
      if (getNx() > 1) {
        ...
        if (!NumericCompare.nearlyEquals(deltaLon, calcDelta)) {
      ...
      if (getNy() > 1) {
        ...
        if (!NumericCompare.nearlyEquals(deltaLat, calcDelta)) {
    ...
    public boolean equals(Object o) {
      ...
      if (!NumericCompare.nearlyEqualsAbs(la1, other.la1, maxReletiveErrorPos * deltaLat))
        return false; // allow some slop, reletive to grid size
      if (!NumericCompare.nearlyEqualsAbs(lo1, other.lo1, maxReletiveErrorPos * deltaLon))
        return false;
      if (!NumericCompare.nearlyEqualsAbs(la2, other.la2, maxReletiveErrorPos * deltaLat))
        return false;
    ...
    public void testHorizCoordSys(Formatter f) {
      ...
      if (Lo2 < lo1)
        Lo2 += 360;
      LatLonPoint startLL = new LatLonPoint(la1, lo1);
      LatLonPoint endLL = new LatLonPoint(la2, Lo2);
  ...
  public abstract static class AbstractRotatedLatLon extends LatLon {
    ...
    public boolean equals(Object o) {
      ...
      if (!(o instanceof AbstractRotatedLatLon)) return false;
      if (!super.equals(o)) return false;
      AbstractRotatedLatLon that = (AbstractRotatedLatLon) o;
      return Double.compare(that.latNorthPole, latNorthPole) == 0 && Double.compare(that.lonNorthPole, lonNorthPole) == 0;
    }

    @Override
    public int hashCode() {
      return Objects.hash(super.hashCode(), latNorthPole, lonNorthPole);
    }
  ...
  public static class RotatedLatLon32769 extends AbstractRotatedLatLon {
    ...
    RotatedLatLon32769(byte[] data) {
      ...
      LatLonPoint unrotated = new LatLonPoint(la1, lo1);
  ...
  public static class Mercator extends Grib2Gds {
    ...
    public boolean equals(Object o) {
      ...
      if (!NumericCompare.nearlyEqualsAbs(la1, that.la1, maxReletiveErrorPos * dY))
        return false; // allow some slop, reletive to grid size
      if (!NumericCompare.nearlyEqualsAbs(lo1, that.lo1, maxReletiveErrorPos * dX))
        return false;
      if (!NumericCompare.nearlyEqualsAbs(lad, that.lad, maxReletiveErrorPos * dY))
        return false;
      if (!NumericCompare.nearlyEquals(dY, that.dY))
        return false;
      return NumericCompare.nearlyEquals(dX, that.dX);
    ...
    public int hashCode() {
      ...
      int useDeltaLon = Math.round(dX / NumericCompare.defaultMaxRelativeDiffFloat);
      int useDeltaLat = Math.round(dY / NumericCompare.defaultMaxRelativeDiffFloat);
  ...
  public static class PolarStereographic extends Grib2Gds {
    ...
    public boolean equals(Object o) {
      ...
      if (!NumericCompare.nearlyEqualsAbs(lo1, that.lo1, maxReletiveErrorPos * dX))
        return false;
      if (!NumericCompare.nearlyEquals(lad, that.lad))
        return false;
      if (!NumericCompare.nearlyEquals(lov, that.lov))
        return false;
      if (!NumericCompare.nearlyEquals(dY, that.dY))
        return false;
      if (!NumericCompare.nearlyEquals(dX, that.dX))
        return false;
    ...
    public int hashCode() {
      ...
      // hashCode() value
      int useLon = (int) Math.round(lo1 / (maxReletiveErrorPos * dX));
      int useLad = Math.round(lad / NumericCompare.defaultMaxRelativeDiffFloat);
      int useLov = Math.round(lov / NumericCompare.defaultMaxRelativeDiffFloat);
      int useDeltaLon = Math.round(dX / NumericCompare.defaultMaxRelativeDiffFloat);
      int useDeltaLat = Math.round(dY / NumericCompare.defaultMaxRelativeDiffFloat);
    ...
    public GdsHorizCoordSys makeHorizCoordSys() {
      ...
      ProjectionPoint start = proj.latLonToProj(new LatLonPoint(la1, lo1));
  ...
  public static class LambertConformal extends Grib2Gds {
    ...
    public boolean equals(Object o) {
      ...
      if (!NumericCompare.nearlyEquals(dX, that.dX))
        return false;
      if (!NumericCompare.nearlyEquals(latin1, that.latin1))
        return false;
      return NumericCompare.nearlyEquals(latin2, that.latin2);
    ...
    public int hashCode() {
      ...
      int useDeltaLon = Math.round(dX / NumericCompare.defaultMaxRelativeDiffFloat);
      int useDeltaLat = Math.round(dY / NumericCompare.defaultMaxRelativeDiffFloat);
      int useLatin1 = Math.round(latin1 / NumericCompare.defaultMaxRelativeDiffFloat);
      int useLatin2 = Math.round(latin2 / NumericCompare.defaultMaxRelativeDiffFloat);
  ...
  public static class SpaceViewPerspective extends Grib2Gds {
    ...
    public void testHorizCoordSys(Formatter f) {
      ...
      LatLonPoint startLL = new LatLonPoint(LaP, LoP);
      LatLonPoint endLL = cs.proj.projToLatLon(endPP);
