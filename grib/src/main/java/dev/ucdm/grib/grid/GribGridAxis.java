...
import dev.ucdm.grib.coord.CoordinateTime;
...
public class GribGridAxis {
  ...
  public static GribGridDataset.CoordAndAxis create(CollectionType type, Coordinate gribCoord, @Nullable GribIosp iosp) {
  ...
  private static AxisType getVertType(String unit) {
    if (SimpleUnit.kmUnit.isCompatible(unit)) {
      return AxisType.Height;
    } else if (SimpleUnit.pressureUnit.isCompatible(unit)) {
