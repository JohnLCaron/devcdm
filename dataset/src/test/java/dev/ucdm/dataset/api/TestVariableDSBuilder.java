...
public class TestVariableDSBuilder {
  ...
  public void testVarDSBuilder() {
    VariableDS var = VariableDS.builder().setName("name").setArrayType(ArrayType.FLOAT).setUnits("units")
        .setDesc("desc").setEnhanceMode(CdmDataset.getEnhanceAll()).build(makeDummyGroup());
    assertThat(var.getUnitsString()).isEqualTo("units");
    assertThat(var.getDescription()).isEqualTo("desc");
    assertThat(var.getEnhanceMode()).isEqualTo(CdmDataset.getEnhanceAll());
  ...
  public void testFromVar() {
    ...
    assertThat(vds.getEnhanceMode()).isEqualTo(CdmDataset.getDefaultEnhanceMode());
    ...
    assertThat(vds2.getEnhanceMode()).isEqualTo(CdmDataset.getEnhanceNone());
    ...
    assertThat(vds3.getEnhanceMode()).isEqualTo(CdmDataset.getEnhanceAll());
  }
