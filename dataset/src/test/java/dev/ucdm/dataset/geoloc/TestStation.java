...
/** Test {@link dev.ucdm.dataset.geoloc.EarthLocation}, {@link dev.ucdm.dataset.geoloc.Station} */
public class TestStation {
  ...
  public void testEarthLocation() {
    ...
    assertThat(loc.latitude()).isEqualTo(lat);
    assertThat(loc.longitude()).isEqualTo(lon);
  ...
  public void testStation() {
    ...
    assertThat(s.longitude()).isEqualTo(lon);
