...
import static dev.ucdm.array.ArrayType.DOUBLE;
import static dev.ucdm.array.ArrayType.INT;
import static dev.ucdm.array.ArrayType.LONG;
import static dev.ucdm.array.ArrayType.SHORT;
import static dev.ucdm.array.ArrayType.UINT;
import static dev.ucdm.array.ArrayType.ULONG;
import static dev.ucdm.array.ArrayType.USHORT;
...
public class EnhanceScaleMissingUnsigned {
  ...
  public boolean isInvalidData(double val) {
    ...
    // NumericCompare.defaultMaxRelativeDiffDouble.
    boolean greaterThanOrEqualToValidMin =
        NumericCompare.nearlyEquals(val, validMin, NumericCompare.defaultMaxRelativeDiffFloat) || val > validMin;
    boolean lessThanOrEqualToValidMax =
        NumericCompare.nearlyEquals(val, validMax, NumericCompare.defaultMaxRelativeDiffFloat) || val < validMax;
  ...
  public boolean isFillValue(double val) {
    return hasFillValue && NumericCompare.nearlyEquals(val, fillValue, NumericCompare.defaultMaxRelativeDiffFloat);
  }
  ...
  public boolean isMissingValue(double val) {
    ...
    for (double aMissingValue : missingValue) {
      if (NumericCompare.nearlyEquals(val, aMissingValue, NumericCompare.defaultMaxRelativeDiffFloat)) {
        return true;
      }
    }
    return false;
