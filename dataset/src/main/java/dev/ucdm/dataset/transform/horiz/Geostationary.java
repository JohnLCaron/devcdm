...
public class Geostationary extends AbstractProjectionCT implements ProjectionBuilder {
  ...
  public Projection makeProjection(AttributeContainer ctv, String geoCoordinateUnits) {
    ...
    return new dev.ucdm.dataset.geoloc.projection.sat.Geostationary(subLonDegrees, perspective_point_height,
  ...
  public Class<? extends Projection> getProjectionClass() {
    return dev.ucdm.dataset.geoloc.projection.sat.Geostationary.class;
  }
