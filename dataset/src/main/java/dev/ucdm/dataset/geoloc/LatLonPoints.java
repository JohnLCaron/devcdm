...
public class LatLonPoints {
  ...
  public static boolean isInfinite(ProjectionPoint pt) {
    return (pt.x() == Double.POSITIVE_INFINITY) || (pt.x() == Double.NEGATIVE_INFINITY)
        || (pt.y() == Double.POSITIVE_INFINITY) || (pt.y() == Double.NEGATIVE_INFINITY);
  }
  ...
  public static String toString(LatLonPoint pt, int sigDigits) {
    return String.format("%s, %s", Format.d(pt.latitude(), sigDigits), Format.d(pt.longitude(), sigDigits));
  }
  ...
  public static String toString(ProjectionPoint pt, int sigDigits) {
    return String.format("%s, %s", Format.d(pt.x(), sigDigits), Format.d(pt.y(), sigDigits));
  }
