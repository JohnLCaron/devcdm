...
public class ADASConvention extends CoordSystemBuilder {
  ...
  private void calcCenterPoints(Projection proj) throws IOException {
    ...
    double false_easting = center_x / 2000 - ppt0.x() * 1000.0;
    ...
    double false_northing = center_y / 2000 - ppt0.y() * 1000.0;
    ...
    double w = dx * (nxpts - 1);
    double h = dy * (nypts - 1);
    double startx = ppt0.x() * 1000.0 - w / 2;
    double starty = ppt0.y() * 1000.0 - h / 2;
