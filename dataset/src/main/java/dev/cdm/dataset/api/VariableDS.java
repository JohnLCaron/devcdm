...
public class VariableDS extends Variable implements VariableEnhanced {
  ...
  @Override
  public Array<?> readArray(dev.cdm.array.Section section)
      throws IOException, dev.cdm.array.InvalidRangeException {
    // really a full read
    if ((null == section) || section.computeSize() == getSize()) {
      return readArray();
    }
    section = dev.cdm.array.Section.fill(section, getShape());
  ...
  @Override
  public Array<?> proxyReadArray(Variable client, dev.cdm.array.Section section, CancelTask cancelTask)
      throws IOException, dev.cdm.array.InvalidRangeException {
