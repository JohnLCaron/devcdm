...
public record Bearing(double azimuth, double backazimuth, double distance) {
  ...
  public static Bearing calculateBearing(Earth e, LatLonPoint pt1, LatLonPoint pt2) {
    return calculateBearing(e, pt1.latitude(), pt1.longitude(), pt2.latitude(), pt2.longitude());
  }
  ...
  public static Bearing calculateBearing(LatLonPoint pt1, LatLonPoint pt2) {
    return calculateBearing(defaultEarth, pt1.latitude(), pt1.longitude(), pt2.latitude(), pt2.longitude());
  }
  ...
  public static LatLonPoint findPoint(Earth e, LatLonPoint pt1, double az, double dist) {
    return findPoint(e, pt1.latitude(), pt1.longitude(), az, dist);
  }
  ...
  public static LatLonPoint findPoint(LatLonPoint pt1, double az, double dist) {
    return findPoint(defaultEarth, pt1.latitude(), pt1.longitude(), az, dist);
  }
